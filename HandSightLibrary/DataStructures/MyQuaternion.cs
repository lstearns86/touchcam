...
namespace HandSightLibrary
{
    public class MyQuaternion
    {
        ...
        public Matrix<double> getQuaternionAsVector() {
        ...
        public static Matrix<double> quaternionProduct(Matrix<double> quaternion, Matrix<double> matrix){
        ...
        public static Matrix<double> quaternionProduct(MyQuaternion q_a, MyQuaternion q_b) {
            Matrix<double> v1 = q_a.getQuaternionAsVector();
            Matrix<double> v2 = q_b.getQuaternionAsVector();
        ...
        public Matrix<double> getConjugate(){
            return new MyQuaternion(this.q1,-this.q2,-this.q3,-this.q4).getQuaternionAsVector();
        }

        public static Matrix<double> getAnglesFromQuaternion(Matrix<double> q) {
            double q0 = q[0, 0];
            double q1 = q[1, 0];
            double q2 = q[2, 0];
            double q3 = q[3, 0];
        ...
        public static Matrix<double> getQuaternionFromAngles(Matrix<double> angle) {
            Matrix<double> result = new Matrix<double>(4, 1);
